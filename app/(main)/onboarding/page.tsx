                    ...
                    <div className="flex justify-center items-center min-w-fit px-4 sm:px-0">
                        <div className="flex items-center gap-2 sm:gap-4">
                            <div className={`flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-2xl transition-all whitespace-nowrap ${
                                currentStep >= 1 
                                    ? 'bg-primary text-white dark:text-background shadow-lg' 
                        ...
                        <div className="mb-6 p-4 bg-primary/5 rounded-xl border border-primary/20">
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-primary text-white dark:text-background rounded-lg hover:bg-primary-hover transition-all"
                                >
