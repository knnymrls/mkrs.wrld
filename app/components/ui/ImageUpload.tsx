...
export default function ImageUpload({ 
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className={`relative w-32 h-32 bg-surface-container-muted ${shapeClasses} overflow-hidden`}>
        {preview ? (
          <>
            <img 
              src={preview} 
          ...
          <div className="w-full h-full flex items-center justify-center text-onsurface-secondary">
